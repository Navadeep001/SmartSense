  ...
  public: {
    Tables: {
      ...
      investments: {
        ...
        Relationships: [
          {
            foreignKeyName: "investments_innovator_id_fkey"
          ...
          {
            foreignKeyName: "investments_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "posts"
            referencedColumns: ["id"]
    ...
    Enums: {
      post_type: "idea" | "milestone"
      post_visibility: "public" | "investors_only" | "private"
      user_role: "innovator" | "investor"
    }
    CompositeTypes: {
      [_ in never]: never
    }
